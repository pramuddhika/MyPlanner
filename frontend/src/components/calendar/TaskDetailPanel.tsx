    ...
    return (
        <div className="h-full flex flex-col bg-slate-900/50 border-l border-slate-800/60">
            ...
            <div className="flex-1 overflow-auto px-5 py-4 space-y-5">
                {/* Title & Status */}
                <div>
                    <h3 className="text-lg font-semibold text-white mb-2">{task.topic}</h3>
                    <Badge
                        variant="outline"
                        className={cn(
                            'text-xs',
                ...
                <div className="space-y-3">
                    {task.category && (
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <span className="text-sm text-slate-300">{task.category.categoryName}</span>
                            </div>
                        </div>
                    )}
                    ...
                    {task.isRemainder && task.remainderTime && (
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <span className="text-xs text-slate-500 block">Reminder</span>
                                <span className="text-sm text-slate-300">
