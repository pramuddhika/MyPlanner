...
export const TaskReminderToast = ({ t, topic, message, timestamp }: TaskReminderToastProps) => {
    ...
    return (
        <div
            ...
            } max-w-sm w-full pointer-events-auto overflow-hidden rounded-xl border border-violet-500/20 bg-slate-900/95 shadow-2xl shadow-violet-500/10 backdrop-blur-sm`}
        >
            {/* Accent bar */}
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                            ...
                            <button
                                ...
                                className="shrink-0 p-1 rounded-md text-slate-500 hover:text-slate-300 hover:bg-slate-800/80 transition-colors"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>

                        <p className="mt-1 text-sm font-medium text-white truncate" title={topic}>
                            {topic}
                        </p>
